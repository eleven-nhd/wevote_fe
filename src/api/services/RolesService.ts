...
export class RolesService {
  ...
  static create(
    ...
    return new Promise((resolve, reject) => {
      let url = basePath + '/api/roles/create';
  ...
  static getPage(
    ...
    return new Promise((resolve, reject) => {
      let url = basePath + '/api/roles/get-page';
  ...
  static getById(
    ...
    return new Promise((resolve, reject) => {
      let url = basePath + '/api/roles/get-by-id/{id}';
  ...
  static update(
    ...
    return new Promise((resolve, reject) => {
      let url = basePath + '/api/roles/update/{id}';
      url = url.replace('{id}', params['id'] + '');
  ...
  static remove(
    ...
    return new Promise((resolve, reject) => {
      let url = basePath + '/api/roles/remove/{id}';
      url = url.replace('{id}', params['id'] + '');
